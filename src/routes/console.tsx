...
export const Route = createFileRoute("/console")({
  head: () => ({
    meta: [
      { title: "Console — SchoolOrder" },
      { name: "description", content: "Manage products, stock, orders, promo codes and dealers." },
      { property: "og:title", content: "Console — SchoolOrder" },
      { property: "og:description", content: "Owner and dealer workspace for the SchoolOrder shop." },
    ...
    <Card>
      ...
      <CardContent className="grid gap-3">
        ...
        <div className="grid gap-2">
          ...
          <Input id="org-name" value={name} onChange={(e) => setName(e.target.value)} className="h-11" />
        </div>
        {error ? (
